    ...
    return (
        ...
        <div className="min-h-screen flex ">
            ...
            <div className="flex flex-col container justify-center mx-auto text-center items-center">
                <h2 className='font-bold md:text-[64px] mx-auto lg:leading-[72px] leading-[45px] max-w-[700px]'>AI-Powered Search as a Service</h2>
                <p className="text-lg text-gray-600 mt-10 mb-12">Unlock your content with KeySemantics.</p>
